...
namespace Builder
{
	public partial class DBWorkView : DBView
	{
		...
		private static string [] _fields_ = new string [] { "id", "lane", "lane_id", "revision_id", "command_id", "state", "starttime", "duration", "logfile", "summary", "workhost_id", "nonfatal", "alwaysexecute", "sequence", "internal", "command", "masterhost_id", "masterhost:MasterHost.host", "workhost:WorkHost.host", "author", "revision" };
		...
		public DBWorkView (IDataReader reader) : base (reader)
		{
		}
